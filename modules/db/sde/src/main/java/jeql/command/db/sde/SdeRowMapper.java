...
public class SdeRowMapper
{
	...
	public RowSchema getSchema(SeQuery query)
	throws SeException
	{
	...
	public Row createRow(RowSchema schema, SeRow seRow)
	throws Exception
	{
...
//		throws SeException
	...
	throws Exception
	{
		...
		throw new ConfigurationException("Unhandled SDE value mapping for class " + destType.getName());
	}
