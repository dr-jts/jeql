...
public class SdeRowList implements RowList 
{
	...
	public SdeRowList(String connectString, String user,
			String password, String sql, SdeRowMapper rowMapper) {
	...
	{		
		...
		try {
			conn = new SeConnection(urlParser.getServer(), urlParser.getInstance(), urlParser.getDatabase(), user, password);
	...
	public RowIterator iterator() {
		if (isRead)
			throw new ExecutionException("Attempt to re-read streamed SDE layer (" + datasetName + ")");
		isRead = true;
