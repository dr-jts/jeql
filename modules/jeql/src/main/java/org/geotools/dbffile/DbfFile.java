...
public class DbfFile implements DbfConsts {
  public static String getLogicalString(boolean b)
  {
    return b ? "T" : "F";
  }
    ...
    /**
            ...
            */
    /*
    public StringBuffer OLDgetNextDbfRec() throws java.io.IOException {
    ...
    */
    ...
    public Object ParseRecordColumn(StringBuffer rec, int wantedCol)
        ...
        case 'L': //logical (MD)
          return parseBoolean(rec.substring(start, end));
    ...
    private static String trueChars = "YyTt";
    private static String falseChars = "NnFf";
     
    protected Boolean parseBoolean(String s)
    {
      char boolCh = s.charAt(0);
      if (trueChars.indexOf(boolCh) >= 0)
        return new Boolean(true);
      if (falseChars.indexOf(boolCh) >= 0)
