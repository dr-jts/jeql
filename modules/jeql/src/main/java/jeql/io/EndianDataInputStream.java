...
public class EndianDataInputStream {
    ...
    public long TESTreadLongLE() throws IOException {
      inputStream.readFully(workSpace, 0, 8);

      return ((long) (workSpace[7]) << 56) |
      ((long) (workSpace[6]) << 48) |
      ((long) (workSpace[5]) << 40) |
      ((long) (workSpace[4]) << 32) |
      ((long) (workSpace[3]) << 24) |
      ((long) (workSpace[2]) << 16) |
      ((long) (workSpace[1]) << 8) | ((long) (workSpace[0]));
  }
    ...
    public double TESTreadDoubleLE() throws IOException {
        long l;

        inputStream.readFully(workSpace, 0, 8);
        l = ((long) (workSpace[7]) << 56) |
            ((long) (workSpace[6]) << 48) |
            ((long) (workSpace[5]) << 40) |
            ((long) (workSpace[4]) << 32) |
            ((long) (workSpace[3]) << 24) |
