...
/* ------------ Commands ----------------------*/
  ...
  final public CommandParameterNode CommandParam() throws ParseException {
        ...
        ParseTreeNode expr = null;
        int line;
    jj_consume_token(S_KEY_IDENTIFIER);
  ...
  Token alias = null;
    if (jj_2_6(2)) {
      ...
      case PLUS:
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case S_KEY_IDENTIFIER:
          alias = jj_consume_token(S_KEY_IDENTIFIER);
          break;
        default:
          jj_la1[19] = jj_gen;
          ;
...
/* parses a list of one or more comma-separated identifiers */
  ...
  private boolean jj_3R_68() {
    if (jj_scan_token(S_KEY_IDENTIFIER)) return true;
    Token xsp;
    xsp = jj_scanpos;
